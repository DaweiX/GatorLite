...
public class Hierarchy {
    ...
    void simpleClassStatistics() {
        ...
        for (SootClass c : scene.getClasses()) {
            ...
            classAndItsConcreteSubTypes.put(c, new HashSet<>());
            classAndItsSubTypes.put(c, new HashSet<>());
            classAndItsSuperTypes.put(c, new HashSet<>());
        }
        System.out.print("[HIERARCHY] All classes: " + numClasses);
        ...
        if (numClasses != appClasses.size() + scene.getLibraryClasses().size()
            ...
            throw new Error("[HIERARCHY] Numbers do not add up");
        }
    }
    ...
    void recordFrameworkInvokedCallbacks() {
        ...
        for (SootClass c : appClasses) {
            ...
            // framework as part of the instantiation process
    ...
    void activityClasses() {
        ...
        if (act == null) {
            throw new Error("[HIERARCHY] Did not find Activity");
        }
        for (SootClass c : appClasses) {
        ...
        System.out.println("[HIERARCHY] Activity Class: " + applicationActivityClasses.size()
                + ", Lib Activity Class: " + libActivityClasses.size());
    }
    ...
    void viewsAndMenus() {
        ...
        if (view == null) {
            throw new Error("[HIERARCHY] Did not find View");
        }
        ...
        System.out.println("[HIERARCHY] App View Class: " + numAppViews + ", Lib View Class: "
                + numLibViews);
    }
    ...
    void dialogs() {
        ...
        System.out.println("[HIERARCHY] App Dialogs: " + applicationDialogClasses.size()
