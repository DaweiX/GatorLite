...
public class WTG {
  ...
  // all wtg nodes
  private final Map<NObjectNode, WTGNode> allNodes;
  // all wtg edges
  private final Map<WTGEdgeSig, WTGEdge> allEdges;
  // all components in wtg
  private final Map<WTGNode, WTGComponent> allComponents;
  // map from forward edge to back edge
  private final Multimap<WTGEdge, WTGEdge> backEdgeMap;
  // map from EventHandlerSig to event handler
  private final Map<EventHandlerSig, EventHandler> allHandlers;
