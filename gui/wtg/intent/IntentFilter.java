...
public class IntentFilter {
  ...
  private final Set<String> mDataTypes;
  private final Set<String> mDataSchemes;
  private final List<PatternMatcher> mDataPaths;
  private final List<AuthorityEntry> mDataAuthorities;
