...
public class CFGAnalyzer {
    private final FlowgraphRebuilder rebuilder;
    private final GUIAnalysisOutput guiOutput;
    private final IntentAnalysis intentAnalysis;
    private final ConstantAnalysis constAnalysis;
    // NInflNode->Set<NActivityNode>, MenuItemNode to target activities
    private final Multimap<NInflNode, NActivityNode> menuItemToActivity = HashMultimap.create();
    // WTG traversal
    private final CFGTraversal cfgTraversal = CFGTraversal.v();
    // WTG util
        ...
        final Filter<Stmt, SootMethod> filter = new Filter<Stmt, SootMethod>() {
            ...
            public boolean match(Stmt unit, SootMethod context) {
                ...
                if (stmtFilter.lookforExitSystem()
                    ...
                    return stmtFilter.isDetectThenStop();
                }
                ...
                if (stmtFilter.lookforFinishActivity()
                    ...
                    return match && stmtFilter.isDetectThenStop();
                }
