...
public abstract class NOpNode extends NNode {
  private static final Map<String, Set<NOpNode>> opNodes = Maps.newHashMap();
  private static final Map<Stmt, NOpNode> stmtAndNodes = Maps.newHashMap();
  ...
  public NVarNode getReceiver() {
    throw new RuntimeException("Fail to get receiver for " + this);
  }

  public abstract boolean hasReceiver();

  public NNode getParameter() {
    throw new RuntimeException("Fail to get parameter for " + this);
  }

  public abstract boolean hasParameter();

  public NVarNode getLhs() {
    throw new RuntimeException("Fail to get lhs for " + this);
  }
